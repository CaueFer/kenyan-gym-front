...
export default function ExperimentalClassesSection() {
  ...
  return (
    <section
      ...
      className="w-screen h-[600px] py-24 px-10 md:px-16 bg-gradient-to-br from-zinc-800 to-black relative z-0 overflow-x-clip"
    >
      <div className="max-w-5xl mx-auto flex items-center h-full">
        <div className="w-full sm:w-1/2 flex flex-col gap-5 z-10">
          <h1 className="text-7xl sm:text-8xl font-kenyan text-white">
            AULA EXPERIMENTAL
          </h1>
        ...
        <div className="absolute w-full md:w-2/3 xl:w-1/2 h-[600px] top-0 right-0 md:mr-[-15vw] lg:mr-[-6vw] xl:mr-[0vw] 2xl:mr-[12vw] grayscale mask-rounded-3xl hidden lg:block">
          <motion.div
        ...
        <div className="absolute w-full h-[600px] z-0 sm:z-10 top-0 left-[30vw] md:left-[45vw]  grayscale mask-rounded-3xl block lg:hidden ">
          <motion.div
            custom={{ index: 0, opacity: 0.3 }}
            initial="hidden"
            whileInView="visible"
