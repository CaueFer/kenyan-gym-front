import React, { ButtonHTMLAttributes, ReactHTMLElement, ReactNode } from "react";
...
export default function DefaultBtn({content, width}: DefaultBtnProps) {
  return (
    <button className={`relative inline-flex overflow-hidden p-[1px] focus:outline-none w-[${width}] `}>
